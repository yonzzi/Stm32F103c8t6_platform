...
#include <stdint.h>
 void  pwm_init()
 {
	...
	*AFIO_MAPR =(0<<12);		//map as time4 channel 1 for PB6
    ...
    uint16_t *TIM4_PSC = (uint32_t *)(0x40000828); // pre scaler
    uint16_t *TIM4_CCR1 = (uint32_t *)(0x40000834);// pwm value count
    uint16_t *TIM4_ARR = (uint32_t *)(0x4000082c); // count max
    uint16_t *TIM4_CR1 = (uint32_t *)(0x40000800);
    uint16_t *TIM4_CCMR1_Output = (uint32_t *)(0x40000818); //capture compare mode output
    uint16_t *TIM4_CCER = (uint32_t *)(0x40000820); // enable compare or capture
 ...
 void pwm_pulse_ctrl(uint16_t pulse)
 {
	 ...
	 uint16_t *TIM4_CCR1 = (uint32_t *)(0x40000834);
	 *TIM4_CCR1 = pulse;
